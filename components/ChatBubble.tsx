...
export const ChatBubble: React.FC<ChatBubbleProps> = ({ 
    message, isLast, onEdit, onRegenerate, onReply, onTranslate, onAudioAction, onDownloadDoc, onMindMap, onShare, onRemoveAudioNote, onAudioNotePlayed, language = 'English', isTutorContext = false
}) => {
        ...
        <div className={`flex flex-col gap-1.5 min-w-0 ${isUser ? 'items-end max-w-[90%]' : 'items-start max-w-[98%] w-full'}`}>
            <div className={`relative text-sm leading-relaxed overflow-hidden break-words transition-all duration-300 ${
                ...
                {isEditing ? (
                  ...
                  <div className={`${isUser ? 'text-white font-bold' : 'text-gray-800 dark:text-gray-200'}`}>
